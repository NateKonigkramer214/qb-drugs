...
RegisterServerEvent('qb-drugs:server:getlysergic', function()
local src = source
...
RegisterServerEvent('qb-drugs:server:getdiethylamide', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setlsdlabkit", src) then
		Player.Functions.RemoveItem("lsdlabkit", 1)
	end
end)	


RegisterServerEvent('qb-drugs:server:removecleaningkit', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)

	if Player.Functions.RemoveItem("cleaningkit", 1) then 
		TriggerClientEvent('QBCore:Notify', src, "Cleaned It Perfectly", "success")
		TriggerClientEvent("qb-drugs:client:resetlsdkit", src)
	else
	TriggerClientEvent('QBCore:Notify', src, "You cant clean it with spit alone", "error")
	end
end)

RegisterServerEvent('qb-drugs:server:getlabkitback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:heatliquid', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:failheating', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:refinequalityacid', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:failrefinequality', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
local randomchance = math.random(1,100)
...
RegisterServerEvent('qb-drugs:server:gettabpaper', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:getlabkit', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:maketabpaper', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
if TriggerClientEvent('qb-drugs:client:taketabs', src, item.name) then
