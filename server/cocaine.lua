...
RegisterServerEvent('qb-drugs:server:makepowder', function()
	local src = source
...
RegisterServerEvent('qb-drugs:server:cutcokeone', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	if Config.TierSystem then		
...
RegisterServerEvent('qb-drugs:server:bagcoke', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
