...
RegisterServerEvent('qb-drugs:server:stealisosafrole', function()
  local src = source
...
RegisterServerEvent('qb-drugs:server:stealmdp2p', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setpresssingle", src) then
		Player.Functions.RemoveItem("singlepress", 1)
	end
end)

RegisterServerEvent('qb-drugs:server:getsinglepressback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setpressdual", src) then
		Player.Functions.RemoveItem("dualpress", 1)
	end
end)

RegisterServerEvent('qb-drugs:server:getdualpressback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setpresstriple", src) then
		Player.Functions.RemoveItem("triplepress", 1)
	end
end)

RegisterServerEvent('qb-drugs:server:gettriplepressback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setpressquad", src) then
		Player.Functions.RemoveItem("quadpress", 1)
	end
end)

RegisterServerEvent('qb-drugs:server:getquadpressback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:buypress', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:upgradepress', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
...
------------- making powder
RegisterServerEvent('qb-drugs:server:makingrawxtc', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  ...
  ----------------------------------- White unstamped
RegisterServerEvent('qb-drugs:server:makextcsingle', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:makextcdual', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
RegisterServerEvent('qb-drugs:server:makextctriple', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
RegisterServerEvent('qb-drugs:server:makextcquad', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
------------------------------------ red unstamped
RegisterServerEvent('qb-drugs:server:makeredxtcsingle', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
RegisterServerEvent('qb-drugs:server:makeredxtcdual', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("loosecoke", 1) then
...
RegisterServerEvent('qb-drugs:server:makeredxtctriple', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("loosecoke", 1) then
...
RegisterServerEvent('qb-drugs:server:makeredxtcquad', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("loosecoke", 1) then
...
RegisterServerEvent('qb-drugs:server:makeorangextcsingle', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
RegisterServerEvent('qb-drugs:server:makeorangextcdual', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("heroinvial", 1) then
...
RegisterServerEvent('qb-drugs:server:makeorangextctriple', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("heroinvial", 1) then
...
RegisterServerEvent('qb-drugs:server:makeorangextcquad', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("heroinvial", 1) then
...
--------------------------------- blue unstamped
RegisterServerEvent('qb-drugs:server:makebluextcsingle', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
...
RegisterServerEvent('qb-drugs:server:makebluextcdual', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("crackrock", 1) then
...
RegisterServerEvent('qb-drugs:server:makebluextctriple', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("crackrock", 1) then
...
RegisterServerEvent('qb-drugs:server:makebluextcquad', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  if Player.Functions.RemoveItem("raw_xtc", 1) then
	if Player.Functions.RemoveItem("crackrock", 1) then
...
RegisterServerEvent('qb-drugs:server:stampwhite', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:stampred', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  local luck = math.random(1,100)
...
RegisterServerEvent('qb-drugs:server:stamporange', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  local luck = math.random(1,100)
...
RegisterServerEvent('qb-drugs:server:stampblue', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  local luck = math.random(1,100)
