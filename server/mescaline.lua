...
RegisterNetEvent("qb-drugs:server:drymescaline")
AddEventHandler("qb-drugs:server:drymescaline", function()
local src = source
...
if Player.Functions.RemoveItem("driedmescaline", 1) then 
	TriggerClientEvent("qb-drugs:client:takemescaline", src)
end
end)
