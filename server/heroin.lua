...
RegisterServerEvent('qb-drugs:server:removecleaningkitheroin', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
	...
	if Player.Functions.RemoveItem("cleaningkit", 1) then
		...
		TriggerClientEvent("qb-drugs:client:deletedirtyheroin", src)
		--TriggerClientEvent("qb-drugs:client:resetheroinkit", src)
	else
...
RegisterServerEvent('qb-drugs:server:dryplant', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:cutheroin', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	if Config.TierSystem then
...
RegisterServerEvent('qb-drugs:server:getheroinlabkit', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:getheroinlabkitback', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
local Player = QBCore.Functions.GetPlayer(src)
	...
	if TriggerClientEvent("qb-drugs:client:setheroinlabkit", src) then
...
RegisterServerEvent('qb-drugs:server:heatliquidheroin', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
	if Config.TierSystem then
...
RegisterServerEvent('qb-drugs:server:failheatingheroin', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:fillneedle', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	if Config.TierSystem then
...
RegisterServerEvent('qb-drugs:server:failheroin', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	if Config.TierSystem then
