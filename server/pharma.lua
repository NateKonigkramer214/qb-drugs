...
RegisterServerEvent('qb-drugs:server:givevicodinprescription', function()
	local src = source
...
RegisterServerEvent('qb-drugs:server:giveadderalprescription', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:givemorphineprescription', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:givexanaxprescription', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:fillprescription', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
if TriggerClientEvent('qb-drugs:client:takepharma', src, item.name) then
