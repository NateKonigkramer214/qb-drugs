...
RegisterServerEvent('qb-drugs:server:startcook', function()
  local src = source
...
RegisterServerEvent('qb-drugs:server:givemethingridients', function()
  local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugs:server:getmeth', function()
  local src = source
  local Player = QBCore.Functions.GetPlayer(src)
  local amount = math.random(1,5)
