           ...
           options = {
               {
                   ...
                   icon = "fas fa-eye",
                   event = "qb-drugs:client:buyheroinlabkit"
               },
           }
...
RegisterNetEvent("qb-drugs:client:dryplant")
AddEventHandler("qb-drugs:client:dryplant", function() 
    ...
    QBCore.Functions.Progressbar("drink_something", "drying out these poppies!", 4000, false, true, {
	    ...
	    TriggerServerEvent("qb-drugs:server:dryplant")
        ClearPedTasks(PlayerPedId())
    end)
end)

RegisterNetEvent("qb-drugs:client:cutheroin")
AddEventHandler("qb-drugs:client:cutheroin", function() 
	TriggerEvent('animations:client:EmoteCommandStart', {'uncuff'}) 
    QBCore.Functions.Progressbar("drink_something", "cutting the heroin!", 4000, false, true, {
	    ...
	    TriggerServerEvent("qb-drugs:server:cutheroin")
        ClearPedTasks(PlayerPedId())
    end)
end)

RegisterNetEvent("qb-drugs:client:buyheroinlabkit")
AddEventHandler("qb-drugs:client:buyheroinlabkit", function() 
    TriggerEvent('animations:client:EmoteCommandStart', {'uncuff'}) 
    QBCore.Functions.Progressbar("drink_something", "Shhhhh!", 4000, false, true, {
	    ...
	    TriggerServerEvent("qb-drugs:server:getheroinlabkit")
        ClearPedTasks(PlayerPedId())
    end)
end)

RegisterNetEvent("qb-drugs:client:setheroinlabkit")
AddEventHandler("qb-drugs:client:setheroinlabkit", function() 
    ...
    options = {
        {
            ...
            event = "qb-drugs:client:heatliquidheroin",
            icon = "fas fa-box-circle-check",
            label = "Cook Heroin",
        },
		{
         
            event = "qb-drugs:client:getheroinkitback",
            icon = "fas fa-box-circle-check",
            label = "Pick Up",
        },
    }
...
RegisterNetEvent("qb-drugs:client:heatliquidheroin")
AddEventHandler("qb-drugs:client:heatliquidheroin", function() 
local PedCoords = GetEntityCoords(PlayerPedId())
TriggerEvent('animations:client:EmoteCommandStart', {'uncuff'}) 
	exports['ps-ui']:Circle(function(success)
    if success then
        TriggerServerEvent("qb-drugs:server:heatliquidheroin")
        ClearPedTasks(PlayerPedId())
	else
		TriggerServerEvent("qb-drugs:server:failheatingheroin")
        ClearPedTasks(PlayerPedId())
		DeleteObject(heroinlabkit)
		Wait(100)
		 ...
		 options = {
        {
            ...
            event = "qb-drugs:client:cleanheroinlabkit",
            icon = "fas fa-box-circle-check",
            label = "Clean It",
        }
    }
...
RegisterNetEvent("qb-drugs:client:cleanheroinlabkit")
AddEventHandler("qb-drugs:client:cleanheroinlabkit", function() 
    ...
    QBCore.Functions.Progressbar("drink_something", "Cleaning", 4000, false, true, {
		...
		TriggerServerEvent("qb-drugs:server:removecleaningkitheroin")
		 ClearPedTasks(PlayerPedId())
	end)
end)

RegisterNetEvent("qb-drugs:client:deletedirtyheroin")
AddEventHandler("qb-drugs:client:deletedirtyheroin", function() 
DeleteObject(dirtylabkitheroin)
Wait(1000)
TriggerEvent("qb-drugs:client:setheroinlabkit")
end)


RegisterNetEvent("qb-drugs:client:getheroinkitback")
AddEventHandler("qb-drugs:client:getheroinkitback", function() 
DeleteObject(heroinlabkit)
TriggerServerEvent("qb-drugs:server:getheroinlabkitback")
ClearPedTasks(PlayerPedId())
end)

RegisterNetEvent("qb-drugs:client:fillneedle")
AddEventHandler("qb-drugs:client:fillneedle", function() 
    TriggerEvent('animations:client:EmoteCommandStart', {'uncuff'}) 
	...
	exports['ps-ui']:Circle(function(success)
    if success then
        TriggerServerEvent("qb-drugs:server:fillneedle")
        ClearPedTasks(PlayerPedId())
	else
		TriggerServerEvent("qb-drugs:server:failheroin")
        ClearPedTasks(PlayerPedId())
	end
