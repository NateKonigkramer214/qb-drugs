...
RegisterNetEvent("qb-drugs:client:drymescaline")
AddEventHandler("qb-drugs:client:drymescaline", function() 
    ...
    QBCore.Functions.Progressbar("drink_something", "Drying Out", 4000, false, true, {
	    ...
	    TriggerServerEvent("qb-drugs:server:drymescaline")
        ClearPedTasks(PlayerPedId())
    end)
end)

RegisterNetEvent("qb-drugs:client:takemescaline")
AddEventHandler("qb-drugs:client:takemescaline", function()
