...
RegisterNetEvent("qb-drugs:client:makepowder")
AddEventHandler("qb-drugs:client:makepowder", function() 
    ...
    QBCore.Functions.Progressbar("drink_something", "chopping plants to powder", 4000, false, true, {
	    ...
	    TriggerServerEvent("qb-drugs:server:makepowder")
        ClearPedTasks(PlayerPedId())
    end)
end)

RegisterNetEvent("qb-drugs:client:cutcokeone")
AddEventHandler("qb-drugs:client:cutcokeone", function() 
	cuttingcoke = true
	CutCoke()
	TriggerServerEvent("qb-drugs:server:cutcokeone")
    ClearPedTasks(PlayerPedId())
	cuttingcoke = nil
   
end)

RegisterNetEvent("qb-drugs:client:bagcoke")
AddEventHandler("qb-drugs:client:bagcoke", function() 
	baggingcoke = true
	BagCoke()
	TriggerServerEvent("qb-drugs:server:bagcoke")
    ClearPedTasks(PlayerPedId())
	baggingcoke = nil
