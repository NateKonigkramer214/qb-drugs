                ...
                options = {
                    {
                        ...
                        label = "Get Task",
                        icon = "fas fa-eye",
                        event = "qb-drugs:client:getsyruplocationtobuy"
                    },
                },
                distance = 2.0
            })
...
RegisterNetEvent("qb-drugs:client:getsyruplocationtobuy")
AddEventHandler("qb-drugs:client:getsyruplocationtobuy", function() 
SpawnCarPedChase()
QBCore.Functions.Notify("Car Has Been Marked On Your Map", "success")
end)

RegisterNetEvent('qb-drugs:client:consumelean', function(itemName)
