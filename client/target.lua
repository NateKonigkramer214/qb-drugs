...
if Config.oxtarget then
	...
	options = {
	 ...
	 exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:makepowder",
				icon = "fas fa-sign-in-alt",
				label = "chop it up",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:cutcokeone",
				icon = "fas fa-sign-in-alt",
				label = "cut up",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:getlysergic",
				icon = "fas fa-sign-in-alt",
				label = "stealing",
			},
		},
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:getdiethylamide",
				icon = "fas fa-sign-in-alt",
				label = "stealing",
			},
		},
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:dryplant",
				icon = "fas fa-sign-in-alt",
				label = "Dry out",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:cutheroin",
				icon = "fas fa-sign-in-alt",
				label = "Cut Heroin",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:fillneedle",
				icon = "fas fa-sign-in-alt",
				label = "Fill Needles",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:makecrackone",
				icon = "fas fa-sign-in-alt",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:bagcrack",
				icon = "fas fa-sign-in-alt",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:fillprescription",
				icon = "fas fa-sign-in-alt",
	...
	exports.ox_target:addBoxZone({
		...
		options = {
			{
				event = "qb-drugs:client:getoxytruck",
				icon = "fas fa-sign-in-alt",
				label = "Pay For Truck",
			},
		}
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:drymescaline",
				icon = "fas fa-sign-in-alt",
				label = "Dry Out",
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
			type = "client",
			event = "qb-drugs:client:stealisosafrole",
			icon = 'fas fa-sign-in-alt',
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:stealmdp2p",
				icon = 'fas fa-eye',
				label = 'Steal mdp2p',
			},
		},
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:makingrawxtc",
				icon = 'fas fa-eye',
				label = 'Make Raw XTC',
			},
		},
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:buypress",
				icon = 'fas fa-eye',
				label = 'Buy Press',
			},
		},
	...
	exports.ox_target:addBoxZone({ -- 963.37, -2122.95, 31.47
		...
		options = {
			{
				type = "client",
				event = "qb-drugs:client:stampwhite",
				icon = 'fas fa-eye',
				label = 'Make White Stamped Pills',
			},
			{
				type = "client",
				event = "qb-drugs:client:stampred",
				icon = 'fas fa-eye',
				label = 'Make Red Stamped Pills',
			},
			{
				type = "client",
				event = "qb-drugs:client:stamporange",
				icon = 'fas fa-eye',
				label = 'Make Orange Stamped Pills',
			},
			{
				type = "client",
				event = "qb-drugs:client:stampblue",
				icon = 'fas fa-eye',
